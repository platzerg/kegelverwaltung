package platzerworld.kegeln.test;
 ...
 */
public class SpinnerActivityTest extends ActivityInstrumentationTestCase2<LigaVerwalten> {
    ...
    private LigaVerwalten mActivity;
    ...
    public SpinnerActivityTest() {
        ...
        super("com.android.example.spinner", LigaVerwalten.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        mSpinner = (Spinner)mActivity.findViewById(R.id.sp_klassen);
